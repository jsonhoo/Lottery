...
public class ManageExchangeAdapter extends RecyclerView.Adapter<ManageExchangeAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public ManageExchangeAdapter(Context context, List data, int layoutId) {
    ...
    @Override
    public ManageExchangeAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        ExchangeModel.ExchangeItem exchangeItem = mDataList.get(position);

        switch (exchangeItem.getUserPayAccountType()) {
            case "1":
        ...
        holder.tv_charge_value.setText("" + exchangeItem.getExchangeValue());
        holder.tv_time.setText(UTCDateUtil.format(exchangeItem.getCreateTime(), UTCDateUtil.FMT_DATETIME));
    }
