...
public class FirmwareModel {
    public static void setUpdateRequired(int deviceId) {
        ...
        LotteryApplication.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.FIRMWARE_UPDATE_REQUIRED, data));
    }
    ...
    public static int getVersionInfo(int deviceId) {
        ...
        data.putInt(MeshConstants.EXTRA_DEVICE_ID, deviceId);
        LotteryApplication.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.FIRMWARE_GET_VERSION, data));
        return id;
    }
