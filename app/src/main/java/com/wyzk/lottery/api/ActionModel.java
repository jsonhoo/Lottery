...
public class ActionModel {
    ...
    public static int setValue(final int deviceId, SensorValue value1, boolean acknowledged) {
        ...
        LotteryApplication.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.ACTION_SET_ACTION, data));
        return id;
    }
    ...
    public static int getTypes(final int deviceId, int firstType) {
        ...
        LotteryApplication.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.ACTUATOR_GET_TYPES, data));
        return id;
    }
    ...
    public static int deleteAction(int deviceId, int actionIDs) {
        ...
        LotteryApplication.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.ACTION_DELETE_ACTION, data));
        return id;
    }
