...
public class PowerModel {
    ...
    public static int getState(int deviceId) {
        ...
        data.putInt(MeshConstants.EXTRA_DEVICE_ID, deviceId);
         LotteryApplication.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.POWER_GET_STATE, data));
        return id;
    }
    ...
    public static int setState(int deviceId, PowerState state, boolean acknowledged) {
        ...
        data.putBoolean(MeshConstants.EXTRA_ACKNOWLEDGED, acknowledged);
         LotteryApplication.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.POWER_SET_STATE, data));
        return id;
    }
    ...
    public static int toggleState(int deviceId, boolean acknowledged) {
        ...
        data.putInt(MeshConstants.EXTRA_DEVICE_ID, deviceId);
        data.putBoolean(MeshConstants.EXTRA_ACKNOWLEDGED, acknowledged);
         LotteryApplication.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.POWER_TOGGLE_STATE, data));
        return id;
    }
