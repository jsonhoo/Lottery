...
public class SensorModel {
    public static int getValue(int deviceId, SensorValue.SensorType type1, SensorValue.SensorType type2) {
        ...
        App.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.SENSOR_GET_VALUE, data));
        return id;
    }
    ...
    public static int setValue(int deviceId, SensorValue value1, SensorValue value2, boolean acknowledged) {
        ...
        App.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.SENSOR_SET_VALUE, data));
        return id;
    }
    ...
    public static int getTypes(int deviceId, SensorValue.SensorType firstType) {
        ...
        App.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.SENSOR_GET_TYPES, data));
        return id;
    }
    ...
    public static int setState(int deviceId, SensorValue.SensorType sensorType, int repeatInterval) {
        ...
        App.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.SENSOR_SET_STATE, data));
        return id;
    }
    ...
    public static int getState(final int deviceId, int sensorType) {
        ...
        App.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.SENSOR_GET_STATE, data));
        return id;
    }
