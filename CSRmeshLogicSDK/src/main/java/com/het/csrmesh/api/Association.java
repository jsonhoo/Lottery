...
public class Association {
    public static void discoverDevices(boolean enabled) {
        ...
        App.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.DISCOVER_DEVICES, data));
    }
    ...
    public static int associateDevice(int deviceHash, long authorizationCode, boolean authorizationCodeKnown, int deviceId) {
        ...
        App.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.ASSOCIATE_DEVICE, data));
        return id;
    }
    ...
    public static void startAdvertising(String shortName, UUID uuid, boolean useAuthCode, long authCode) {
        ...
        App.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.START_ADVERTISING, data));
    }

    public static void stopAdvertising() {
        Bundle data = new Bundle();
        App.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.STOP_ADVERTISING, data));
    }
    ...
    public static void attentionPreAssociation(int deviceHash, boolean enabled, int duration) {
        ...
        App.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.ATTENTION_PRE_ASSOCIATION, data));
    }
    ...
    public static void resetDevice(int deviceId, byte[] resetKey) {
        ...
        App.bus.post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.MASP_RESET, data));
    }
